 <?php /* Module: B 50% width */
		...
		if( $cb_query->have_posts() ) {
		  ...
		  $cb_final_score = NULL;
		  echo '<div class="cb-module-b cb-half-mod clearfix"><h2 class="cb-module-title">'.$parent_cat_name.'</h2>';
                   ...
                   <div class="mask">
                       ...
                       <a href="<?php the_permalink(); ?>">
                          ...
                          <?php } 
						  	 ...
						  	 if ((false != $format) && ($format != 'review')) {echo '<span class="cb-icon '. $format . '-icon"></span>'; } 
						  ?>
                       </a>
