...
<body>
	<div id="button-dialog">
		<form action="/" method="get" accept-charset="utf-8">
			<div>
				<label for="button-color">Gallery Size</label>
				<select name="button-color" id="size-gallery" size="1">
			...
			<div>
				<label for="button-text">1) Image url</label>
			...
			<div>
				<label for="button-text">2) Image url</label>
			...
			<div>
				<label for="button-text">3) Image url</label>
			...
			<div>
				<label for="button-text">4) Image url</label>
