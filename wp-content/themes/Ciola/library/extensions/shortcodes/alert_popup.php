		...
		<form action="/" method="get" accept-charset="utf-8" onsubmit="javascript:ButtonDialog.insert(ButtonDialog.local_ed);return false;">
			...
			<div>
				...
				<select name="button-type" id="button-type" size="1">
					<option value="alert-white" selected="selected">White</option>
					<option value="alert-red"=>Red</option>
					<option value="alert-green"=>Green</option>
					<option value="alert-yellow">Yellow</option>
					<option value="alert-blue">Blue</option>
				</select>
			</div>
			<div>	
