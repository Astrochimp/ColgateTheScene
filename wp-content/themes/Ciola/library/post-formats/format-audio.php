<?php
	...
	if (isset($cb_custom_fields['cb_soundcloud_embed_code_post'][0])) { $cb_featured_audio_url = $cb_custom_fields['cb_soundcloud_embed_code_post']; } else {$cb_featured_audio_url = NULL;}
...
<div class="cb-audio-frame"><?php if ($cb_featured_audio_url != NULL) { echo do_shortcode($cb_custom_fields['cb_soundcloud_embed_code_post'][0]); }?></div>
