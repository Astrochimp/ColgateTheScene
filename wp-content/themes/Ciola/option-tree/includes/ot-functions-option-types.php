        ...
        if ( ! empty( $categories ) ) {
          ...
          foreach ( $categories as $category ) {
            echo '<p>';
              ...
              echo '<label for="' . esc_attr( $field_id ) . '-' . esc_attr( $count ) . '">' . esc_attr( $category->name ) . '<span></span></label>';
            echo '</p>';
            $count++;
          } 
        } else {
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $query->have_posts() ) {
          ...
          while ( $query->have_posts() ) {
            ...
            echo '<p>';
              echo '<input type="checkbox" name="' . esc_attr( $field_name ) . '[' . esc_attr( $count ) . ']" id="' . esc_attr( $field_id ) . '-' . esc_attr( $count ) . '" value="' . esc_attr( get_the_ID() ) . '" ' . ( isset( $field_value[$count] ) ? checked( $field_value[$count], get_the_ID(), false ) : '' ) . ' class="option-tree-ui-checkbox ' . esc_attr( $field_class ) . '" />';
              echo '<label for="' . esc_attr( $field_id ) . '-' . esc_attr( $count ) . '">' . get_the_title() . '<span></span></label>';
            echo '</p>';
            $count++;
          } 
        } else {
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $query->have_posts() ) {
          ...
          while ( $query->have_posts() ) {
            ...
            echo '<p>';
              echo '<input type="checkbox" name="' . esc_attr( $field_name ) . '[' . esc_attr( $count ) . ']" id="' . esc_attr( $field_id ) . '-' . esc_attr( $count ) . '" value="' . esc_attr( get_the_ID() ) . '" ' . ( isset( $field_value[$count] ) ? checked( $field_value[$count], get_the_ID(), false ) : '' ) . ' class="option-tree-ui-checkbox ' . esc_attr( $field_class ) . '" />';
              echo '<label for="' . esc_attr( $field_id ) . '-' . esc_attr( $count ) . '">' . esc_attr( get_the_title() ) . '<span></span></label>';
            echo '</p>';
            $count++;
          } 
        } else {
        ...
        if ( $tags ) {
          ...
          foreach( $tags as $tag ) {
            echo '<p>';
              ...
              echo '<label for="' . esc_attr( $field_id ) . '-' . esc_attr( $count ) . '">' . esc_attr( $tag->name ) . '<span></span></label>';
            echo '</p>';
            $count++;
          } 
        } else {
        ...
        if ( $taxonomies ) {
          ...
          foreach( $taxonomies as $taxonomy ) {
            echo '<p>';
              ...
              echo '<label for="' . esc_attr( $field_id ) . '-' . esc_attr( $count ) . '">' . esc_attr( $taxonomy->name ) . '<span></span></label>';
            echo '</p>';
            $count++;
          } 
        } else {
